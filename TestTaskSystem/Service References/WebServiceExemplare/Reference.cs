...
namespace TestTaskSystem.WebServiceExemplare {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WebServiceExemplare.ISolidWebService")]
    public interface ISolidWebService {
        ...
        TestTaskSystem.WebServiceExemplare.DataModel[] Search(string nameSegment);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISolidWebService/Search", ReplyAction="http://tempuri.org/ISolidWebService/SearchResponse")]
        System.Threading.Tasks.Task<TestTaskSystem.WebServiceExemplare.DataModel[]> SearchAsync(string nameSegment);
        ...
        TestTaskSystem.WebServiceExemplare.TransmittableFile SelectFile(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISolidWebService/SelectFile", ReplyAction="http://tempuri.org/ISolidWebService/SelectFileResponse")]
        System.Threading.Tasks.Task<TestTaskSystem.WebServiceExemplare.TransmittableFile> SelectFileAsync(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel);
        ...
        string GetPathSelectFile(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISolidWebService/GetPathSelectFile", ReplyAction="http://tempuri.org/ISolidWebService/GetPathSelectFileResponse")]
        System.Threading.Tasks.Task<string> GetPathSelectFileAsync(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel);
        ...
        string[] GetConfigiguration(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISolidWebService/GetConfigiguration", ReplyAction="http://tempuri.org/ISolidWebService/GetConfigigurationResponse")]
        System.Threading.Tasks.Task<string[]> GetConfigigurationAsync(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel);
        ...
        TestTaskSystem.WebServiceExemplare.Specification[] GetSpecifications(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel, string configuration);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISolidWebService/GetSpecifications", ReplyAction="http://tempuri.org/ISolidWebService/GetSpecificationsResponse")]
        System.Threading.Tasks.Task<TestTaskSystem.WebServiceExemplare.Specification[]> GetSpecificationsAsync(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel, string configuration);
        ...
        void CreateRoof(int height, int wight, TestTaskSystem.WebServiceExemplare.RoofTypes type, int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISolidWebService/CreateRoof", ReplyAction="http://tempuri.org/ISolidWebService/CreateRoofResponse")]
        System.Threading.Tasks.Task CreateRoofAsync(int height, int wight, TestTaskSystem.WebServiceExemplare.RoofTypes type, int userId);
        ...
        void CreateVibroInsertion(int height, int wight, TestTaskSystem.WebServiceExemplare.VibroInsertionTypes type, int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISolidWebService/CreateVibroInsertion", ReplyAction="http://tempuri.org/ISolidWebService/CreateVibroInsertionResponse")]
        System.Threading.Tasks.Task CreateVibroInsertionAsync(int height, int wight, TestTaskSystem.WebServiceExemplare.VibroInsertionTypes type, int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISolidWebService/testYesNotS", ReplyAction="http://tempuri.org/ISolidWebService/testYesNotSResponse")]
        int testYesNotS(int x);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISolidWebService/testYesNotS", ReplyAction="http://tempuri.org/ISolidWebService/testYesNotSResponse")]
        System.Threading.Tasks.Task<int> testYesNotSAsync(int x);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISolidWebServiceChannel : TestTaskSystem.WebServiceExemplare.ISolidWebService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SolidWebServiceClient : System.ServiceModel.ClientBase<TestTaskSystem.WebServiceExemplare.ISolidWebService>, TestTaskSystem.WebServiceExemplare.ISolidWebService {
        ...
        public TestTaskSystem.WebServiceExemplare.DataModel[] Search(string nameSegment) {
            return base.Channel.Search(nameSegment);
        }
        
        public System.Threading.Tasks.Task<TestTaskSystem.WebServiceExemplare.DataModel[]> SearchAsync(string nameSegment) {
            return base.Channel.SearchAsync(nameSegment);
        }
        
        public TestTaskSystem.WebServiceExemplare.TransmittableFile SelectFile(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel) {
            return base.Channel.SelectFile(dataSolidModel);
        }
        
        public System.Threading.Tasks.Task<TestTaskSystem.WebServiceExemplare.TransmittableFile> SelectFileAsync(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel) {
            return base.Channel.SelectFileAsync(dataSolidModel);
        }
        
        public string GetPathSelectFile(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel) {
            return base.Channel.GetPathSelectFile(dataSolidModel);
        }
        
        public System.Threading.Tasks.Task<string> GetPathSelectFileAsync(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel) {
            return base.Channel.GetPathSelectFileAsync(dataSolidModel);
        }
        
        public string[] GetConfigiguration(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel) {
            return base.Channel.GetConfigiguration(dataSolidModel);
        }
        
        public System.Threading.Tasks.Task<string[]> GetConfigigurationAsync(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel) {
            return base.Channel.GetConfigigurationAsync(dataSolidModel);
        }
        
        public TestTaskSystem.WebServiceExemplare.Specification[] GetSpecifications(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel, string configuration) {
            return base.Channel.GetSpecifications(dataSolidModel, configuration);
        }
        
        public System.Threading.Tasks.Task<TestTaskSystem.WebServiceExemplare.Specification[]> GetSpecificationsAsync(TestTaskSystem.WebServiceExemplare.DataModel dataSolidModel, string configuration) {
        ...
        public void CreateRoof(int height, int wight, TestTaskSystem.WebServiceExemplare.RoofTypes type, int userId) {
            base.Channel.CreateRoof(height, wight, type, userId);
        }
        
        public System.Threading.Tasks.Task CreateRoofAsync(int height, int wight, TestTaskSystem.WebServiceExemplare.RoofTypes type, int userId) {
            return base.Channel.CreateRoofAsync(height, wight, type, userId);
        }
        
        public void CreateVibroInsertion(int height, int wight, TestTaskSystem.WebServiceExemplare.VibroInsertionTypes type, int userId) {
            base.Channel.CreateVibroInsertion(height, wight, type, userId);
        }
        
        public System.Threading.Tasks.Task CreateVibroInsertionAsync(int height, int wight, TestTaskSystem.WebServiceExemplare.VibroInsertionTypes type, int userId) {
            return base.Channel.CreateVibroInsertionAsync(height, wight, type, userId);
        }
        
        public int testYesNotS(int x) {
            return base.Channel.testYesNotS(x);
        }
        
        public System.Threading.Tasks.Task<int> testYesNotSAsync(int x) {
            return base.Channel.testYesNotSAsync(x);
        }
    }
}
