...
namespace PDMWebService.Data.Solid.ElementsCase
{
    public sealed class MountingFrameBuilder : ProductBuilderBehavior
    {
        ...
        public void BuildMountageFrame(bool cheched, double width, double lenght, double thikness, int type, double offset, string material, IList<string> покрытие, bool onlyPath)
        {
                if (cheched)
                {
                    width = width - 20;
                ...
                {
                    /*
                     * Washer 11371_gost =  Шайба DIN 125
                     * Washer 6402_gost =   Шайба DIN 7980
                     * Hex Bolt 7805_gost = Болт DIN 933
                     * Hex Nut 5915_gost =  Гайка DIN 934
                    */
