...
namespace PDMWebService.Data.Solid.ElementsCase
{
    ...
    {       
        ...
        public string Build(SpigotType_e type, Vector2 spigotSize)
        {
              ...
              base.PartPrototypeName = GetModelName(type);
            base.PartName = GetSpigotName(type, spigotSize);               
            Dimension dimension;
            int addDimH = base.PartPrototypeName == "12-30" ? 10 : 1;            
            NewPartPath = $@"{RootFolder}{SubjectDestinationFolder}\{base.PartName}";
            ...
            if (base.PartPrototypeName == "12-20")
            {
                ...
                {
                    CheckExistPart(base.PartName, out IsPartExist, out base.NewPartPath);
                }
                else
                {
                ...
                {
                    base.NewPartPath = $@"{RootFolder}\{SubjectDestinationFolder}\{base.NewPartPath}";
                ...
                MessageObserver.Instance.SetMessage("Check exist part. " + base.NewPartPath);
                if (CheckExistPart != null)
                {
                ...
                {                    
                    ...
                    assemblyDocument.ReplaceComponents(base.PartName, "", true, true);                 
                }
                else
                {
                    base.NewPartPath = $@"{RootFolder}\{SubjectDestinationFolder}\{base.NewPartPath}";
            ...
            swDrawingSpigot.Extension.SaveAs(NewPartPath + ".SLDDRW", (int)swSaveAsVersion_e.swSaveAsCurrentVersion, (int)swSaveAsOptions_e.swSaveAsOptions_Silent, null, ref error, ref warning);
        ...
        public static  string GetSpigotName(SpigotType_e spigotType, Vector2 size,  bool isShowExtension = false)
        {
            ...
            var spigotName = GetModelName(spigotType) + "-" + size.X + "-" + size.Y;
            if (isShowExtension)
                spigotName += ".SLDASM";
            return spigotName;
        }
