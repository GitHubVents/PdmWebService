...
//                        {
//                            var pdm = SolidWorksPdmAdapter.Instance;             // add conditions: which of pdm systems will be initialised. 
...
//                            string pathToTempFile = PdfBuilder.Instance.Build();

//                            string pathToPdmFile = SolidWorksPdmAdapter.Instance.AddToPdm(pathToTempFile, dataModel.FolderPath);
